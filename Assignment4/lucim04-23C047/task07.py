...
Original file is located at
    https://colab.research.google.com/drive/1fbulkh2idgv-xWDZtTmaHhAoH385-dY4
...
SELECT ?subclass
WHERE {
    ?subclass rdf:type/rdfs:subClassOf* ?livingThing .
}
""",
initNs={'livingThing': LIVING_THING_URI}
)
...
# Visualize the results
for row in results:
    print(row.individual)  # Print each individual
